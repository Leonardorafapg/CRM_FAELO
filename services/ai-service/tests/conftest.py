...
padrao dos outros servicos — ver comentarios la pra detalhe de cada fixture."""
import os

os.environ["DATABASE_URL"] = os.getenv(
    "TEST_DATABASE_URL",
    "postgresql://postgres:Minhasenha%40123@localhost:5432/crm_faelo_ai_test",
)
os.environ["JWT_SECRET_KEY"] = "test-secret-key-nao-usar-em-producao"
os.environ["JWT_ALGORITHM"] = "HS256"
os.environ["PLATFORM_SERVICE_URL"] = "http://platform-service.invalid"
...
import app.faq.models  # noqa: F401 — registra FaqItem em Base.metadata

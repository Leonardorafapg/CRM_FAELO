...
padrao do crm-service — ver comentarios la pra detalhe de cada fixture."""
import os

os.environ["DATABASE_URL"] = os.getenv(
    "TEST_DATABASE_URL",
    "postgresql://postgres:Minhasenha%40123@localhost:5432/crm_faelo_whatsapp_test",
)
...
os.environ["EVOLUTION_API_URL"] = "http://evolution.invalid"
...
import app.connections.models  # noqa: F401 — registra Connection em Base.metadata
import app.chat.models         # noqa: F401 — registra Session/Message
